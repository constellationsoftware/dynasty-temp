...
#   #$ext_path = Rails.root.join('vendor', 'assets', 'javascripts', 'extjs')
...
#   load Rails.root.join('vendor', 'assets', 'javascripts', 'extjs', 'resources', 'themes')
#   sass_options = { :debug_in`fo => false } # by Compass.app
