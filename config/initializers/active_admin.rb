ActiveAdmin.setup do |config|
    ...
    #    admin.site_title = "Account"
    #end
    #
    #config.namespace :team_account do |team_account|
    #    admin.site_title = "Team Account"
    #end
    #
    #config.namespace :league_account do |league_account|
    #    admin.site_title = "League Account"
    #end
