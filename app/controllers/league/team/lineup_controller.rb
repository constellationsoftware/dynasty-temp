class League::Team::LineupController < SubdomainController
    ...
    protected
        def collection
            ...
            Lineup.reflect_on_association(:player_teams).options[:conditions] = "#{PlayerTeamRecord.table_name}.user_team_id = #{@team_id}"
