...
ActiveRecord::Schema.define(:version => 20120203193449) do
  ...
  add_index "display_names", ["last_name", "first_name", "entity_type"], :name => "index_display_names_on_last_name_and_first_name_and_entity_type"
